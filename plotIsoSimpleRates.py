...
#        print_rates(hm, 'highest_muon_absEtaMin0_absEtaMax2.5_qmin12'+iso_wp_str+'_pt', scaleFactor=convFactorToHz / 1000.)
        ...
        #print_rates(hm, 'highest_muon_absEtaMin0_absEtaMax2.5_qmin12'+iso_wp_str+'_pt', scaleFactor=convFactorToHz / 1000. / nCollBunches)
        #print_rates(hm, 'highest_muon_absEtaMin0_absEtaMax2.1_qmin12'+iso_wp_str+'_pt', scaleFactor=convFactorToHz / 1000. / nCollBunches)
        #print_rates(hm, 'highest_muon_absEtaMin0_absEtaMax2.5_qmin4'+iso_wp_str+'_pt', scaleFactor=convFactorToHz / 1000. / nCollBunches)
        #print_rates(hm, 'highest_muon_absEtaMin0_absEtaMax2.1_qmin4'+iso_wp_str+'_pt', scaleFactor=convFactorToHz / 1000. / nCollBunches)
