...
def plot_hists_qstack(hm, hName, den=None, xTitle='', yTitle='# muons', threshold=False, stacked=False, normToBinWidth=False, tfMuonOrig='ugmt', reg='', scaleFactor=1., data=False):
    ...
    return plot_hists(hm, hDefs, xTitle, yTitle, threshold, normToBinWidth, prefix, notes, scaleFactor, data=data)
...
def main():
    ...
    objects.append(plot_hists_standard(hm, 'muon_ptmin4_qmin12_eta', xTitle='#eta', yTitle='', stacked=True, normToBinWidth=True, data=thisIsData, scaleFactor=1./nZeroBiasEvents))
    objects.append(plot_hists_standard(hm, 'muon_ptmin8_qmin12_eta', xTitle='#eta', yTitle='', stacked=True, normToBinWidth=True, data=thisIsData, scaleFactor=1./nZeroBiasEvents))
    ...
    objects.append(plot_hists_standard(hm, 'muon_ptmin4_qmin8_eta', xTitle='#eta', yTitle='', stacked=True, normToBinWidth=True, data=thisIsData, scaleFactor=1./nZeroBiasEvents))
    objects.append(plot_hists_standard(hm, 'muon_ptmin8_qmin8_eta', xTitle='#eta', yTitle='', stacked=True, normToBinWidth=True, data=thisIsData, scaleFactor=1./nZeroBiasEvents))
    ...
    objects.append(plot_hists_standard(hm, 'muon_ptmin4_qmin4_eta', xTitle='#eta', yTitle='', stacked=True, normToBinWidth=True, data=thisIsData, scaleFactor=1./nZeroBiasEvents))
    objects.append(plot_hists_standard(hm, 'muon_ptmin8_qmin4_eta', xTitle='#eta', yTitle='', stacked=True, normToBinWidth=True, data=thisIsData, scaleFactor=1./nZeroBiasEvents))
